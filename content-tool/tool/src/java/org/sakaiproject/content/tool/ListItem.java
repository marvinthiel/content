/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/content/branches/sakai-2.7.x/content-tool/tool/src/java/org/sakaiproject/content/tool/ListItem.java $
 * $Id: ListItem.java 95999 2011-08-01 15:53:13Z arwhyte@umich.edu $
 ***********************************************************************************
 *
...
public class ListItem
{
    ...
    protected boolean displayBeforeRelease;
...
//		}
        ...
        // Need to read the displayBeforeRelease from the entity
        this.displayBeforeRelease = !this.displayBeforeRelease;
	...
	public ListItem(ResourceToolActionPipe pipe, ListItem parent, Time defaultRetractTime)
	{
		...
		this.displayBeforeRelease = false;
		this.useRetractDate = false;
	...
	protected void captureAvailability(ParameterParser params, String index)
	{
        ...
        boolean display_pending = params.getBoolean("display_pending" + index);
		...
		if(use_start_date)
		{
            ...
            this.displayBeforeRelease = display_pending;
		}
		else
		{
...
//		}
	...
	/**
     * @param setDisplayBeforeRelease the displayBeforeRelease to set
     */
    public void setDisplayBeforeRelease(boolean displayBeforeRelease)
    {
    	this.displayBeforeRelease = displayBeforeRelease;
    }
	...
	/**
     * @return the displayBeforeRelease
     */
    public boolean displayBeforeRelease()
    {
    	return displayBeforeRelease;
    }
	...
	{
        // Need to add the displayBeforeRelease stuff
