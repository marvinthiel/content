/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/content/branches/sakai-2.7.x/content-tool/tool/src/java/org/sakaiproject/content/tool/ResourcesEditItem.java $
 * $Id: ResourcesEditItem.java 77513 2010-05-17 14:25:04Z jonrcook@indiana.edu $
 ***********************************************************************************
 *
	...
	extends ResourcesBrowseItem
{
    ...
    protected boolean m_displayBeforeRelease;
	...
	/**
	 ...
	 {
		 return m_displayBeforeRelease;
	 }

	 /**
	  * @param displayBeforeRelease the displayBeforeRelease to set
	  */
	 public void setDisplayBeforeRelease(boolean displayBeforeRelease)
	 {
		 this.m_displayBeforeRelease = displayBeforeRelease;
	 }
