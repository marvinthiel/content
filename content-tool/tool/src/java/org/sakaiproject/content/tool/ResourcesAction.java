/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/content/branches/sakai-2.7.x/content-tool/tool/src/java/org/sakaiproject/content/tool/ResourcesAction.java $
 * $Id: ResourcesAction.java 93036 2011-05-18 22:05:15Z arwhyte@umich.edu $
 ***********************************************************************************
 *
...
//			}
			...
			else
			{
                ...
                // Set displayBeforeRelease from the entity
                item.setDisplayBeforeRelease(true);
...
//		}
		...
		for(int i = 0; i < CREATE_MAX_ITEMS; i++)
		{
			...
			item.setHidden(false);
			item.setUseReleaseDate(false);
			item.setDisplayBeforeRelease(false);
			item.setReleaseDate(TimeService.newTime());
			item.setUseRetractDate(false);
			item.setRetractDate(defaultRetractDate);
			item.setInWorkspace(isUserSite);
